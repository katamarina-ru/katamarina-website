...
Это руководство опирается на руководство [Выделенная сеть для LINSTOR]({{% ref "https://cozystack.ru/docs/v1.5/storage/dedicated-network" %}}) и добавляет методы и шаблоны конфигурации, характерные для окружений с несколькими дата-центрами.
...
Инструкции см. в руководстве [Топологические метки узлов]({{% ref "https://cozystack.ru/docs/v1.5/operations/stretched/labels" %}}).
