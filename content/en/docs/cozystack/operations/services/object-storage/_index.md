...
- [SeaweedFS Service Reference]({{% ref "https://cozystack.ru/docs/v1.5/operations/services/seaweedfs" %}}) -- autogenerated parameter table для SeaweedFS package
- [SeaweedFS Multi-DC Configuration]({{% ref "https://cozystack.ru/docs/v1.5/operations/stretched/seaweedfs-multidc" %}}) -- развертывание SeaweedFS в нескольких дата-центрах
