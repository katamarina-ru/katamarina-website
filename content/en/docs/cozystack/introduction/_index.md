...
Он может использоваться отдельной компанией для запуска собственного [частного облака](https://cozystack.ru/docs/v1.2/guides/use-cases/private-cloud) или поставщиком услуг для предоставления
[платформы как услуги](https://cozystack.ru/docs/v1.2/guides/use-cases/public-cloud) нескольким клиентам.

Cozystack закрывает наиболее важные потребности команды разработчиков:

-   [Кластеры Kubernetes](https://cozystack.ru/docs/v1.2/cozystack-api) для запуска приложений в среде разработки и в продакшене
-   Стандартные [управляемые приложения](https://cozystack.ru/docs/v1.2/applications): базы данных, менеджеры очередей, кэши и многое другое
-   [Виртуальные машины](https://cozystack.ru/docs/v1.2/virtualization)
-   Надёжное распределённое хранилище

[Платформенный стек Cozystack](https://cozystack.ru/docs/v1.2/guides/platform-stack) включает надёжные компоненты, которые обычно устанавливаются
...
Ещё одна мощная функция — [система тенантов](https://cozystack.ru/docs/v1.2/guides/concepts#tenant-system).
...
[Система тенантов](https://cozystack.ru/docs/v1.2/guides/concepts#tenant-system) Cozystack решает эти проблемы,
...
[Система единого входа](https://cozystack.ru/docs/v1.2/operations/oidc) в Cozystack работает на базе Keycloak.
...
В Cozystack [виртуальные машины](https://cozystack.ru/docs/v1.2/virtualization)
...
Cozystack избегает этого, запуская [управляемые базы данных](https://cozystack.ru/docs/v1.2/applications)
...
[вариант Cozystack](https://cozystack.ru/docs/v1.2/operations/configuration/variants), подходящий для ваших нужд.
