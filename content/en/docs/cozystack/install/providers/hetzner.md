...
Установка в Hetzner включает общие [требования к оборудованию]({{% ref "/docs/v1.5/install/hardware-requirements" %}}) с несколькими дополнениями.
...
прочитайте [Talos Linux в Cozystack]({{% ref "/docs/v1.5/guides/talos" %}}).
...
Есть [несколько вариантов]({{% ref "/docs/v1.5/install/kubernetes" %}}) создания и применения конфигурации Talos.
...
Эта часть руководства основана на общем [руководстве по Talm]({{% ref "/docs/v1.5/install/kubernetes/talm" %}}),
...
1.  Создайте каталог для конфигурации кластера и инициализируйте в нем проект Talm.
    ...
    [руководстве по Talm]({{% ref "/docs/v1.5/install/kubernetes/talm#2-initialize-cluster-configuration" %}}).
...
Следуйте [руководству по настройке хранилища]({{% ref "/docs/v1.5/getting-started/install-cozystack#3-configure-storage" %}}) из tutorial по Cozystack.
