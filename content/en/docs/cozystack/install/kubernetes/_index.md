...
Если вы устанавливаете Cozystack впервые, [начните с руководства по Cozystack]({{% ref "/docs/v1.5/getting-started" %}}).

## Варианты установки

### Talos Linux (рекомендуется)

Для production-развертываний Cozystack рекомендует использовать [Talos Linux]({{% ref "/docs/v1.5/guides/talos" %}}) в качестве базовой операционной системы.
Предварительное условие для этих методов — [установленный Talos Linux]({{% ref "/docs/v1.5/install/talos" %}}).
...
-   После установки и настройки кластера Kubernetes можно
    [установить и настроить Cozystack]({{% ref "/docs/v1.5/install/cozystack" %}}).
