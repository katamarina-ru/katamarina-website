...
Первичную настройку и детали конфигурации см. в [Monitoring Setup]({{% ref "https://cozystack.ru/docs/v1.5/operations/services/monitoring/setup" %}}).
...
Для совместимости соблюдайте [metric naming conventions](https://prometheus.io/docs/practices/naming/) Prometheus. Примеры конфигурации см. в [Monitoring Hub Reference]({{% ref "https://cozystack.ru/docs/v1.5/operations/services/monitoring" %}}).
...
Чтобы изменить настройки источников данных, откройте Grafana admin panel (нужны admin privileges) или обновите monitoring configuration через Cozystack API. Подробные параметры см. в [Monitoring Hub Reference]({{% ref "https://cozystack.ru/docs/v1.5/operations/services/monitoring" %}}).
